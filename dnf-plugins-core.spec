...
Version  : 4.0.4
Release  : 19
URL      : https://github.com/rpm-software-management/dnf-plugins-core/archive/4.0.4.tar.gz
Source0  : https://github.com/rpm-software-management/dnf-plugins-core/archive/4.0.4.tar.gz
...
%prep
%setup -q -n dnf-plugins-core-4.0.4
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1550716531
mkdir -p clr-build
pushd clr-build
