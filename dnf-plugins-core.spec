...
Version  : 3.0.1
Release  : 13
URL      : https://github.com/rpm-software-management/dnf-plugins-core/archive/3.0.1.tar.gz
Source0  : https://github.com/rpm-software-management/dnf-plugins-core/archive/3.0.1.tar.gz
...
%prep
%setup -q -n dnf-plugins-core-3.0.1
%patch1 -p1
%patch2 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1531435031
mkdir clr-build
pushd clr-build
